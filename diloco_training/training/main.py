...
if __name__ == "__main__":
    ...
    parser.add_argument("--optim_method", type=str, default="sgd", choices=["demo", "sgd", "ddp"], help="Optimizer.")
    parser.add_argument("--quantization", type=bool, default=False, help="Enable quantization.")
    parser.add_argument("--checkpoint_path", type=str, default="checkpoint.pth", help="Checkpoint path.")
    parser.add_argument("--checkpoint_interval", type=int, default=512, help="Checkpoint interval.")
    parser.add_argument("--device", type=str, default="cuda", choices=["cuda", "cpu"], help="Device.")
    parser.add_argument("--wandb_user_key", type=str, default=None, help="WandB user key.")
    parser.add_argument("--wandb_project_name", type=str, default="diloco_training", help="WandB project name.")
